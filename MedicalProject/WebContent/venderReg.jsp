...
<body>
	...
	<div class="container" style="height: 850px;">
		<div class="registerbox w3-container w3-card-4 w3-light-grey" style="width: 500px; height: 700px;">
			<h2 style="margin-top: 90px;">Register New Vender</h2><br><br>
		...
		<br><br>	<input type="text" name="vender" placeholder="Shop Name" required>
			...
			<input type="submit" value="Submit" style="margin-top: 20px;hover-blue" >
		</div>
		</div>
	</form>

...
<center>	
	...
	<div class="container" style="height: 850px;">
		<div class="registerbox w3-container w3-card-4 w3-light-grey " style="width: 500px; height: 600px;">
			<h2 style="margin-top: 70px;">Register New User</h2>
		...
		<br><br>	<input type="password" name="pass1" placeholder="Enter Password" required>
			<input type="password" name="pass2" placeholder="Retype Password" required><br>
